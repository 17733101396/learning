...
<script src="js/manage.js?version=1"></script>

</head>

<body style=" background-image: url(images/manage/back.png);height:568px;overflow:hidden; opacity:0.7;">
  <input id="paramUsername" type="hidden" value="${param.paramUserName}">
  <input id="paramPassword" type="hidden" value="${param.paramPassword}">
  <input id="paramPower" type="hidden" value="${param.paramPower}">
  ...
  <div class="manage-contain" style="height:600px" >
      ...
      <div id="rightTop" class="rightTop" style="height:40px">
      <span class="glyphicon glyphicon-cog" style="color: rgb(67, 113, 130); font-size: 30px;"></span>
      </div>
          <div id="rightBody" class="rightBody" style="float:right; width:100%; margin-left:2%;height:530px;overflow:scroll;"></div>
      </div>
  </div>
</body>
</html>
