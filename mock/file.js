...
let id = 1;
const dir = 'D:/桌面/file-test/';
export default {

    'GET /file/selectFiles': (req, res) => {
        //res.status(401).send();
        res.json(data);
    },

    'GET /file/selectFilesByUser': (req, res) => {
        //res.status(401).send();
        console.log(req.query);
        res.json(data.filter(item => item.admin_id == req.query.admin_id));
    },

    'POST /file/deleteFiles': (req, res) => {
